...
modules_enabled = {
	...
	-- Other specific functionality
		...
		"conversejs";
		--"auth_oauthbearer"; -- komt in "authorisation"
		"sasl_oauthbearer";
}
...
cross_domain_websocket = { "https://app.dwo.nl", "https://test.dwo.nl" }
...
oauth_url = "https://app.dwo.nl/dwo/oauth2/verify.jsp?client_id={{oauth_client_id}}&token={{password}}"
...
archive_expires_after = "10w" -- Remove archived messages after 1 week
...
https_certificate = "/etc/prosody/certs/chat.dwo.nl.crt"
